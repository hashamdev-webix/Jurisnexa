      ...
      <section className="bg-white py-14">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-4 leading-relaxed text-slate-muted">
            ...
            assistance under one professional platform. Our services are designed
            for law firms, businesses, startups, HR teams, corporate legal
            departments, professionals, and job seekers who need reliable
            guidance, staffing support, documentation assistance, and consultation
            services in India.
          </p>
        </div>
      </section>
